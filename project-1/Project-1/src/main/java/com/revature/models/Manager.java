...
public class Manager {
	...
	@Id //Primary Key
	@Column(name="ma_id")//column name
	@GeneratedValue(strategy=GenerationType.AUTO) //SERIAL
	private int id;
	
	@Column(name="ma_username", nullable=false)
	private String username;
	
	@Column(name="ma_password", nullable=false)
	private String password;
	
	@Column(name="ma_first_name", nullable=false)
	private String firstName;
	
	@Column(name="ma_last_name", nullable=false)
	private String lastName;
	
	@Column(name="ma_email", nullable=false)
	private String email;
	
	@Column(name="ma_role_id", nullable=false)
